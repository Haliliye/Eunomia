...
import type { TeamMember, BoardColumn } from '@/types/team'
...
export default function UserStoryFilterBar({ members, columns, userNames, filters, onChange }: UserStoryFilterBarProps) {
