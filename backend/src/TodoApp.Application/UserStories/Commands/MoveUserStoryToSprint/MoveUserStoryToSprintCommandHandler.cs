...
public class MoveUserStoryToSprintCommandHandler : IRequestHandler<MoveUserStoryToSprintCommand>
{
    private readonly IUserStoryRepository _userStoryRepository;
    private readonly ITeamRepository _teamRepository;
    private readonly IRealtimeNotifier _realtimeNotifier;

    public MoveUserStoryToSprintCommandHandler(IUserStoryRepository userStoryRepository, ITeamRepository teamRepository, IRealtimeNotifier realtimeNotifier)
    {
    ...
    public async Task Handle(MoveUserStoryToSprintCommand request, CancellationToken cancellationToken)
    {
        ...
        story.MoveToSprint(request.SprintId);
