...
public class UnarchiveUserStoryCommandHandler : IRequestHandler<UnarchiveUserStoryCommand>
{
    private readonly IUserStoryRepository _userStoryRepository;
    private readonly ITeamRepository _teamRepository;
    private readonly IRealtimeNotifier _realtimeNotifier;

    public UnarchiveUserStoryCommandHandler(IUserStoryRepository userStoryRepository, ITeamRepository teamRepository, IRealtimeNotifier realtimeNotifier)
    {
    ...
    public async Task Handle(UnarchiveUserStoryCommand request, CancellationToken cancellationToken)
    {
