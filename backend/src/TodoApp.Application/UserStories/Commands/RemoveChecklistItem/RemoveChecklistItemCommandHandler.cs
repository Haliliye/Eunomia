...
public class RemoveChecklistItemCommandHandler : IRequestHandler<RemoveChecklistItemCommand>
{
    private readonly IUserStoryRepository _userStoryRepository;
    private readonly ITeamRepository _teamRepository;
    private readonly IRealtimeNotifier _realtimeNotifier;

    public RemoveChecklistItemCommandHandler(IUserStoryRepository userStoryRepository, ITeamRepository teamRepository, IRealtimeNotifier realtimeNotifier)
    {
    ...
    public async Task Handle(RemoveChecklistItemCommand request, CancellationToken cancellationToken)
    {
        ...
        story.RemoveChecklistItem(request.ItemId);
